...
(function () {
  ...
  function registerFound(w) {
    ...
    updateProgress();
    renderFoundList();
    if (w.spangram) flash("🌟 You found the spangram: " + w.word + "!", "var(--green)");
    else flash("Nice! You found " + w.word + " 🎉", "var(--green)");
