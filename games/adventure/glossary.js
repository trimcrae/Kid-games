...
(function (global) {
  ...
  const WORDS = [
    ...
    { w: "grumbling", d: "Complaining in a low, muttery voice.", f: ["grumble", "grumbles", "grumbled"] },
    { w: "grumpy", d: "In a bad mood — and letting everybody know it.", f: ["grumpily", "grouchy", "grouchily"] },
    ...
    { w: "proud", d: "Really pleased and happy about something you did.", f: ["proudly"] },
    { w: "grand", d: "Big, showy and important-looking.", f: ["grandly"] },
    { w: "marvels", d: "To be filled with wonder at something amazing.", f: ["marvel", "marvelled", "marveled", "marvelling", "marveling"] },
    ...
    { w: "lumbers", d: "To walk slowly and heavily, the way a very big animal walks.", f: ["lumbered", "lumbering"] },
    ...
    { w: "curious", d: "Really wanting to find out more about something.", f: ["curiously"] },
    ...
    { w: "delighted", d: "Very, very pleased and happy.", f: ["delight", "delights"] },
    { w: "furious", d: "Full of fierce, fast feeling — really angry, or going flat out.", f: ["furiously"] },
    ...
    { w: "wisdom", d: "Knowing the smart, kind thing to do, learned from experience." },
    { w: "wise", d: "Good at working out the smart, kind thing to do.", f: ["wisely"] },
    ...
    { w: "signature", d: "Your own name written the special way only you write it.", f: ["signatures"] },
