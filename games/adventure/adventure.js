/* ===========================================================
   ...
   stories-long.js), showing each generated illustration,
   reading the words aloud, and remembering which
...
(function () {
  ...
  function buildLibrary() {
    ...
    STORIES.forEach(story => {
      ...
      card.style.background = `linear-gradient(160deg, color-mix(in srgb, ${story.color}, white 22%), color-mix(in srgb, ${story.color}, black 42%))`;
      ...
      AdventureImages.show(card.querySelector(".cover"), story.coverImg, "cover-img");
    });
  ...
  function goTo(id, push) {
    ...
    AdventureImages.show(artEl, node.img, "scene-img");
    if (!reduceMotion) {
