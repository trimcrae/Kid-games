...
window.CPArt = (function () {
  ...
  /* How many pixels a panorama gets. On a desktop the place is a wide
     banner and the 240-wide panorama would be four screen pixels a cell,
     so it is painted at twice the pixels there: the same picture, the
     same palette and dither, about as fine on the screen as a phone's.
     The view through a window stays at one, it is small enough already. */
