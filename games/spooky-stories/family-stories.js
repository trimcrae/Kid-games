...
window.FAMILY_STORIES = [
  ...
  },
  {
    ...
    pages: [
      ...
      { title: "A wobbly idea", text: "Cory stacked all six blocks into a tall tower. It looked impressive, but it did not reach across the water. He took it down carefully. “I need a bridge, not a tower.” He laid three blocks end to end on the rug. They reached exactly as far as the gap.", alt: "Cory compares a six-block tower with three blocks laid end to end across a measured gap.", vocab: { impressive: "making you stop and look because something seems special" }, wonder: "How many blocks are left after Cory sets out three?" },
