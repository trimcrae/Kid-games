...
(function () {
  ...
  const PUZZLES = [
    ...
    },
    {
      ...
      little: ["act", "ant", "art", "cat", "cot", "oat", "rat", "rot", "sat", "tan", "tar", "ton", "tot"],
    },
    {
      name: "Rainbow Bright",
      emoji: "🌈",
    ...
    },
    {
      ...
      little: ["her", "hoe", "hue", "toe", "ore", "set", "sue", "use", "the", "see", "tee", "rue"],
    },
    {
      name: "In the Garden",
      emoji: "🌻",
      ...
      little: ["age", "and", "are", "ear", "era", "gas", "nag", "ran", "rag", "sad", "sea", "gag"],
    },
    {
      name: "Birthday Party",
      emoji: "🎉",
      ...
      little: ["ate", "art", "eat", "sat", "sit", "tea", "tie", "tip", "tap", "tar", "pat", "pit", "rat", "its"],
    },
    {
      name: "Monster Mash",
      emoji: "👹",
      ...
      words: [
        ...
        "monsoon", "monsoons", "sonnet", "sonnets", "roost", "roosts",
        "remotes", "mentors", "tremors", "sermon", "sermons", "moments",
        "nonsense", "rooster", "roosters", "sooner", "tenors",
    ...
    },
    {
      ...
      little: ["con", "ion", "inn", "nor", "run", "sin", "son", "sun", "urn", "nun"],
    },
    {
      name: "Camping Trip",
      emoji: "🏕️",
      ...
      little: ["cap", "can", "cam", "gap", "map", "man", "nap", "pan", "amp", "aim", "nag", "gag"],
    },
    {
      name: "Royal Kingdom",
      emoji: "👑",
      ...
      little: ["dog", "don", "goo", "moo", "nod", "odd", "ion", "koi"],
    },
    {
      name: "Helping Hands",
      emoji: "🤝",
      ...
      little: ["eel", "gel", "hen", "leg", "pen", "peg", "pep", "pie", "gee", "lie"],
    },
    ...
    /* ---------- newer hives — always APPEND, never insert ---------- */
    {
      ...
      words: [
        ...
        "sorrows", "follower", "followers",
      ],
      little: ["low", "owl", "for", "foe", "ore", "row", "sow", "woe", "fro", "roe", "off"],
    },
    {
      name: "Princess Dress",
      emoji: "👗",
      ...
      little: ["ice", "pie", "pen", "see", "ire", "err"],
    },
    {
      name: "Diamond Mine",
      emoji: "⛏️",
      ...
      words: [
        ...
        "dooms", "doom", "damson", "damsons", "misdo", "domino", "sandman",
      ],
    ...
    },
    {
      ...
      words: [
        ...
        "clear", "clears", "cellar", "cellars", "caller",
        "callers", "recall", "recalls", "career", "careers", "recap",
        "recaps", "apple", "apples", "please", "pleases", "relapse",
        ...
        "spear", "spares", "spears", "carpel", "carpels", "escapees",
        "parallels", "scalpel", "scalpels", "sparse", "seascape",
        "seascapes", "caresses", "pearl", "pearls", "reappear",
        "reappears",
      ],
      little: ["ace", "ale", "ape", "are", "ear", "eel", "era", "pea", "sea", "see", "err"],
    },
  ];
  ...
  const DEFS = {
    ...
    sensor: "a part that notices things — like heat or movement",
    misdo: "to do something the wrong way",
    sandman: "the make-believe fellow who sprinkles sleep in your eyes",
    scalpel: "the tiny sharp knife a surgeon uses",
    sparse: "spread thin, with big gaps in between",
    seascape: "a painting or view of the sea",
    escapee: "someone who has escaped",
    parallel: "two lines that run side by side and never meet",
    recap: "a quick re-telling of what happened",
    reappear: "to show up again after being gone",
    crispiness: "how lovely and crunchy something is",
    follower: "someone who comes along behind and copies the leader",
    swore: "said a promise out loud — the past of swear",
    engaged: "busy and joined in — or promising to get married",
    restroom: "the toilets in a public place",
    grandad: "your mum or dad\'s dad",
    outer: "on the outside",
    truest: "the most true of them all",
    ninepin: "one of the pins you knock down in bowling",
  };
  function defFor(w) {
