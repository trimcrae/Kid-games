...
import {lots} from './neighborhood-layout.mjs';
export const activities = [
  ...
  {id:'well',room:"Mom & Dad's office",icon:'📚',name:'Word library',detail:'Reading, spelling and vocabulary',view:'well'},
  {id:'read',room:"Mom & Dad's office",icon:'📖',name:'Read a book',detail:'Read the books in your bag',view:'nest',action:'read'},
  ...
  {id:'rest',room:"Kieran's bedroom",icon:'🌙',name:'Rest',detail:'A cosy place to recover energy',view:'nest',action:'rest'},
  {id:'dress',room:"Mom & Dad's bedroom",icon:'👒',name:'Wardrobe',detail:'Hats, glasses and scarves',view:'nest',action:'dress'},
  ...
  {id:'bank',room:"Mom & Dad's office",icon:'🏦',name:'Family bank',detail:'Deposits, withdrawals and interest',view:'bank'},
  ...
  {id:'diary',room:"Ellie's bedroom",icon:'📔',name:'Diary',detail:'Write, draw and remember your adventures',view:'diary'},
  {id:'case',room:"Jeannie's bedroom",icon:'🏆',name:'Trophies & visits',detail:'Achievements, family visits and presents',view:'case'},
  ...lots.map(p=>({id:'pet-house-'+p.id,room:p.room,owner:p.id,icon:'🏡',name:'Visit '+p.name+"'s Craepet house",detail:'Saved homes, furniture, decorating and presents',view:'home'})),
];
