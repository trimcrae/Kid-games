...
export const ROUTINES={
  ...
  shannon:{day:[s('Living room',.64,2.13,'sit',{up:true}),s('Living room',2.35,2.3,'play')],night:[s("Mom & Dad's bedroom",14.42,6.2,'nap',{up:true})]},
  tristan:{day:[s('Living room',.63,2.96,'sit',{up:true}),s('Living room',1.9,1.8,'play')],night:[s("Mom & Dad's bedroom",14.42,6.7,'nap',{up:true})]},
