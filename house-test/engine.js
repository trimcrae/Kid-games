...
(function () {
  ...
  var HOUSE_KEYS = (window.CraepetsSaveMode && window.CraepetsSaveMode.prefix) || "craepets.house.";
  var WHO_KEY = HOUSE_KEYS + "who";
  var slot = function (who) { return HOUSE_KEYS + "v1." + who; };
  ...
  var VOICE_KEY = HOUSE_KEYS + "voice";
