// House edition fork. See make-activity-clone.cjs; original game is unchanged.
/* ===========================================================
   ...
   trophy case, all kept in localStorage:
       ...
       craepets.house.who        -> whose turn it is right now
       craepets.house.v1.<who>   -> that person's whole valley
...
(function () {
  ...
  var WHO_KEY = "craepets.house.who";
  var slot = function (who) { return "craepets.house.v1." + who; };
  ...
  var VOICE_KEY = "craepets.house.voice";
  ...
  function marketHtml() {
    ...
    return '<p><button class="ghost" data-goto="bank">🏦 Walk to the bank in the basement office</button></p>' + '<div class="panel">' +
