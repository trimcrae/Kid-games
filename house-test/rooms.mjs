...
export const rooms=[
  ...
  ['Main floor','Dining room',5.6,7.5,0,Math.PI,[6.1,7.6,-1.047]],
  ...
  ['Upstairs',"Mom & Dad's bedroom",13.45,5.1,1.26,0,[13.4,4.7,-2.88]],
  ['Upstairs',"Mom & Dad's bathroom",11.4,7.85,1.26,Math.PI/2],
  ['Upstairs','Green bathroom',11.1,5.0,1.26,0,[10.75,5.2,2.618]],
  ['Upstairs',"Kieran's bedroom",12.5,3.0,1.26,Math.PI,[12.9,2.4,1.833]],
  ['Upstairs',"Cory's bedroom",15.8,4.1,1.26,-Math.PI/2,[16.8,4.3,-2.618]],
  ['Downstairs','Family room',10.3,2.7,-1.05,-Math.PI/2,[10.6,3.0,-1.3]],
  ['Downstairs','Shared bedroom entry',11.5,5.1,-1.05,0,[11.5,5.8,0]],
  ['Downstairs',"Ellie's bedroom",10.4,6.2,-1.05,Math.PI/2,[10,6.6,1.1]],
  ['Downstairs',"Jeannie's bedroom",12.6,5.75,-1.05,-Math.PI/2,[13.2,6.35,1.047]],
  ...
  ['Basement','Laundry',6.3,6.6,-3.15,0,[6.5,6.9,0]],
