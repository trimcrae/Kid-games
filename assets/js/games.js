...
const GAMES = [
  {
    title: "Craepets",
    emoji: "🥚",
    blurb: "Adopt a pixel creature and raise it — the whole economy runs on learning. Five levels from toddler to grown-up, and the questions HEAT UP as you get better: five right in a row turns the heat up a rung (bigger sums, more coins, and at the top a peek at the level above). Climb The Shade's Shadow Tower: his shadow army on six floors, then The Shade himself, darker every time you beat him — with charged critical hits, snacks from your bag, a family Craepet as your ally, tricks, and loot only he can drop. The little levels are now read aloud in a real storyteller's voice: every question, every lesson, the pet's chatter and The Shade's sneers. NEW: dress your Craepet up in pixel hats, glasses and scarves it wears everywhere; grant its wishes (it asks for one thing at a time — read it, do it, get paid); read the diary it writes about its day, and write in it yourself; post presents with a note to anyone in the family, or walk round and VISIT their house to see their room and their pet; every species has favourite foods and a favourite place; the pet wanders about its room and grows with every level; take a photo of it to keep; and the valley follows the real clock, with stars in the window after dark. Over 700 hand-written questions plus endless generated sums, 37 homes, 200+ pieces of furniture, painted views, and a different Market for everyone.",
    url:   "games/craepets/",
    ages:  "2+",
