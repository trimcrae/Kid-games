...
console.log('PASS: 25 books; 3 classics; 29 story pages; 9 quizzes; vocabulary and narration match the reader' + (process.argv.includes('--media') ? '; all 29 illustrations present.' : '.'));
